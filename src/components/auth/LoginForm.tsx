  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 mt-2">Sign in to your CareerPulse account</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link to="/forgot-password" className="text-sm font-medium text-careerpulse-blue hover:underline">
              Forgot password?
            </Link>
          </div>
          <Input
        ...
        <Button type="submit" className="w-full bg-careerpulse-blue hover:bg-careerpulse-blue/90">
          Sign in
        </Button>
      </form>
      ...
      <div className="mt-6 text-center text-sm">
        ...
        <Link to="/register" className="font-medium text-careerpulse-blue hover:underline">
          Sign up now
        </Link>
      </div>
    </div>
